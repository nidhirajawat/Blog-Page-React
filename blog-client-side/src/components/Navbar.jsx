...
import { FaBars, FaFacebook, FaInstagram, FaLinkedinIn, FaXmark } from "react-icons/fa";
  ...
  return (
    <header className='bg-black text-white fixed top-0 left-0 right-0'>
      ...
      <div className='text-white lg:flex gap-4 items-center hidden'>
        ...
        <button className='bg-orange-500 px-6 py-2 font-medium rounded rounded hover:bg-white hover:text-orange-500 transition-all duration-200 ease-in'>Log in</button>
      </div>
